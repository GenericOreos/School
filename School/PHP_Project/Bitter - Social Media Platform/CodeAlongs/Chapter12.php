...
$valid = checkdate(10, 31, 2019);
echo $valid . "<BR>";
//set the locale
setlocale(LC_ALL, "can-EN");
echo strftime("%A, %B %d, %Y, %T") . "<BR>"; //show day, date, month, year, time
echo date("F d, Y") . "<BR>";
//times
echo date("h:i:s") . "<BR>"; //i for minuntes 
$dateArray = getdate();
print_r($dateArray);
echo"<BR>";
echo "This page was last modified " . date("F d, Y H:i:s", getlastmod()) . "<BR>";
