...
<head>
	<title>Simple Scripting Demo - The Exercise!</title>
</head>
...
// "Retrieve Desired Record Set"
	...
	//$strCategory = "Tools";
	$strSQL = "SELECT ID, Category, Image, Price, Description, Option1Desc, Option1a, Option1b, Option1c, Option1d,"
                . " Option2Desc, Option2a, Option2b, Option2c, Option2d FROM Products ORDER BY ID";
	   ...
	   echo '
		...
		if ( $rowProd["Option1Desc"] != "" ) {
		   	echo '
				...
				. $rowProd["Option1Desc"];
                                if($rowProd["Option1a"] != ""){
                                   echo '<br><li>'.$rowProd["Option1a"];
                                }
                                if($rowProd["Option1b"] != ""){
                                   echo '<br><li>'.$rowProd["Option1b"];
                                }
                                if($rowProd["Option1c"] != ""){
                                   echo '<br><li>'.$rowProd["Option1c"];
                                }
                                if($rowProd["Option1d"] != ""){
                                    echo '<br><li>'.$rowProd["Option1d"];
                                }
		}	
		...
		if ( $rowProd["Option2Desc"] != "" ) {
		   	echo '
				...
				. $rowProd["Option2Desc"];
                                if($rowProd["Option2a"] != ""){
                                   echo '<br><li>'.$rowProd["Option2a"];
                                }
                                if($rowProd["Option1b"] != ""){
                                   echo '<br><li>'.$rowProd["Option2b"];
                                }
                                if($rowProd["Option1c"] != ""){
                                   echo '<br><li>'.$rowProd["Option2c"];
                                }
                                if($rowProd["Option1d"] != ""){
                                    echo '<br><li>'.$rowProd["Option2d"];
                                }
		}	
} // End of the while		
